...
class NewPopSynthForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'sigma': _(mark_safe("<b>SIGMA</b>: sigma is the dispersion in the Maxwellian for the SN kick speed (190 km/s).")),
            ...
            'bkick': _(mark_safe("<b>BKICK</b>: bkick Not sure if does anything")),
