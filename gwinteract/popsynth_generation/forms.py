...
class NewPopSynthForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'natal_kick_array': _(mark_safe("<b>NATAL_KICK_ARRAY</b>: Hand select the natal kick and kick angle for each star (order is kick1, kick2, phi1, phi2, theta1, theta2)")),
            'qcrit_array': _(mark_safe("<b>QCRIT_ARRAY</b>: ")),
        }
